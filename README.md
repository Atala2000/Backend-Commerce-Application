...
This is a backend application for an e-commerce website. It is built using Django and Django Rest Framework. The application provides various features such as user authentication, product management, order management, payment processing, and user profile management.
...
## Installation
The installation process for the backend e-commerce application involves cloning the repository, setting up a virtual environment, installing the required packages, applying migrations, creating a superuser, and running the development server.

## API Endpoints
The backend e-commerce application provides several API endpoints for different functionalities such as user accounts, products, cart management, payment processing, and order history.

## Authentication and Permissions
The application includes CSRF protection and admin access control. Only admin users have the permission to update or delete products.

## Usage with Postman
The documentation provides instructions on how to test the API endpoints using Postman. It includes sample requests for listing categories, products, updating products, and searching products.

## Cart Endpoints
The application also includes endpoints for managing the user's cart, such as viewing cart contents, adding items to the cart, and clearing the cart.

## Payment Endpoints
The payment endpoints allow users to create and execute payments using different payment methods. The documentation provides the required parameters for creating and executing payments.

## Payment History Endpoints
The payment history endpoints allow users to view their payment history and retrieve specific payments by transaction ID.

## Mpesa Payment
The application also supports M-Pesa payment integration. It includes endpoints for initiating payments, handling callbacks from M-Pesa, and viewing order history.

## License
The project is licensed under the MIT License. The license details can be found in the [LICENSE](LICENSE) file.

## Contributing
The documentation provides guidelines for contributing to the project, including forking the repository, creating a feature branch, committing changes, and opening pull requests.

## Contact
The documentation includes contact information for any inquiries related to the project.
# Backend E-commerce Application
